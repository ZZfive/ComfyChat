...
import sys
server_dir = '/root/code/ComfyChat/audio'
parent_dir =  os.path.abspath(os.path.join(server_dir, '..'))
# sys.path.append(now_dir)
sys.path.append(os.path.join(parent_dir, "audio/GPT-SoVITS"))
sys.path.append(os.path.join(parent_dir, "audio/GPT-SoVITS/GPT_SoVITS"))
